...
WARNING: this image is deprecated in favor of [gluufederation/docker-certmanager](https://github.com/GluuFederation/docker-certmanager).

## Versions

- Stable: `N/A`
- Unstable: `gluufederation/key-rotation:4.2.0_dev`
